  ...
  return (
    <>
      ...
      >
        ...
        <Stack w="100%" maw={300} mt="md" gap="sm">
          <Link href="/cs/inzeraty" style={{ width: "100%" }}>
            <Button size="lg" radius="md" color="white" c="orange" fullWidth>
              Zobrazit inzeráty
            </Button>
          </Link>
          <Link href="/cs/inzeraty/novy" style={{ width: "100%" }}>
            <Button size="lg" radius="md" variant="outline" color="white" c="white" fullWidth>
              Přidat inzerát
            </Button>
          </Link>
        </Stack>
      ...
      <SimpleGrid cols={{ base: 3, sm: 6 }} spacing="md" mb={80}>
        {[
